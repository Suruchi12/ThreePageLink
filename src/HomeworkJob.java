...
import static org.apache.hadoop.fs.FileUtil.fullyDelete;

public class HomeworkJob {
    public static void main(String[] args) throws Exception {

        fullyDelete(new File(new Path(args[1] + "_temp").toString()));
        fullyDelete(new File(new Path(args[1]).toString()));

        Job job = new Job();

        /* Autogenerated initialization. */
        initJob(job, HomeworkMapper.class, HomeworkReducer.class);
        ...
        if (job.waitForCompletion(true)) {
            ...
            /* Autogenerated initialization. */
            initJob(job, HomeworkMapper2.class, HomeworkReducer2.class);
